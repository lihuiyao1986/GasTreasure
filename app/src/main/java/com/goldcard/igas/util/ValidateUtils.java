...
public class ValidateUtils {
     ...
     * @return
     */
    public static final boolean isInteger(String number){
     ...
     */
    private static final boolean match(String pattern,String str){
     ...
     * @return 是否合法
     */
    public static final boolean emailFormat(String email){
        boolean tag = true;
