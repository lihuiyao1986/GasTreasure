...
import com.goldcard.igas.widget.tabindicator.TabPageIndicator;
...
public class BadgeView extends TextView {
    ...
    public BadgeView(Context context, TabPageIndicator target, int index) {
        this (context, null, android.R.attr.textViewStyle, target, index);
    }
    ...
    private void applyTo(View target){
        ...
        if (target instanceof TabPageIndicator) {
            target = ((TabPageIndicator) target).getTabViewByIndex (targetTabIndex);
            this.target = target;
            RelativeLayout rr = (RelativeLayout) target;
            RelativeLayout.LayoutParams rrLP = new RelativeLayout.LayoutParams (LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
            rrLP.addRule (RelativeLayout.ALIGN_PARENT_RIGHT, RelativeLayout.TRUE);
            rrLP.addRule (RelativeLayout.ALIGN_PARENT_TOP, RelativeLayout.TRUE);
            rr.addView (container, rrLP);
            this.setVisibility (View.GONE);
            container.addView (this);
            target.invalidate ();
        } else {
