 ...
 */
package com.goldcard.igas.widget.tabindicator;
...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    /**
     *@Description: 根据index获取对应的tabView 
     *@Author: 李焱生
     *@Since: 2015年5月14日上午10:46:13
     *@param index
     *@return
     */
    @Override
    public View getTabViewByIndex(int index){
        int totalChildCount = mTabLayout.getChildCount ();
        if(totalChildCount < index)
        {
